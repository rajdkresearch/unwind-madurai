...
export default function Footer() {
  return (
    <footer className="bg-[#041007] border-t border-gold/10 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-gold hover:border-gold/30 transition-colors">
                <Share2 size={16} />
              </a>
              <a href="#" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-gold hover:border-gold/30 transition-colors">
          ...
          <div>
            ...
            <div className="mt-5 p-3 bg-gold/5 border border-gold/15 rounded-xl">
              <p className="text-xs text-gold/70 font-medium">Open Daily</p>
