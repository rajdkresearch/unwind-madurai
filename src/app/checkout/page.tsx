    ...
    <div className="min-h-screen pt-24 pb-16 max-w-5xl mx-auto px-4 sm:px-6">
      ...
      {!hasBookingDetails && (
        <div className="glass-card p-5 mb-6 flex items-center gap-3 border-amber-500/20 bg-amber-500/5">
          ...
          <div>
            <p className="text-sm font-semibold text-white">No booking selected</p>
            ...
            {!user ? (
              <div className="space-y-3">
                <div className="p-4 bg-gold/5 border border-gold/20 rounded-xl text-center">
                  ...
                  <p className="text-xs text-white/40 mb-3">Sign in to confirm your booking. Takes just a second.</p>
                  <button
                    onClick={() => router.push('/login?redirect=/checkout')}
                    className="w-full py-3 bg-gold text-black font-bold rounded-xl hover:bg-gold/90 transition-all flex items-center justify-center gap-2 text-sm"
                  >
